...
I chain vulnerabilities into realistic attack paths rather than isolated findings. A 2FA bypass at Aylo prevented **~$27K in bug-bounty payouts**; I map AD attack paths with BloodHound, NetExec, and Mimikatz and build Python and AI-assisted tooling for secrets discovery and automation.
